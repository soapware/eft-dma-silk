...
namespace eft_dma_radar.Silk.UI
{
    internal static partial class RadarWindow
    {
        ...
        private static void DrawWindows()
        {
            ...
            {
                try { EspCustomizationPanel.Draw(); }
                catch (Exception ex)
                {
                    Log.Write(AppLogLevel.Error, $"[EspCustomizationPanel] Draw exception: {ex.Message}");
                    EspCustomizationPanel.IsOpen = false;
                }
            }
        ...
        private static void ApplyImGuiDarkStyle()
        {
            ...
            var accentBase   = new Vector4(0.70f, 0.00f, 0.67f, 1.0f);
            var accentHover  = new Vector4(1.00f, 0.00f, 0.961f, 1.0f);
            var accentActive = new Vector4(0.55f, 0.00f, 0.53f, 1.0f);
            ...
            // Checkboxes
            colors[(int)ImGuiCol.CheckMark]           = new Vector4(1.00f, 0.00f, 0.961f, 1.0f);
